...
const TRANSLATIONS = {
    en: {
        ...
        'buff.ranged.desc': 'Gain Ranged Attack (Range 3)',
    ...
    ru: {
        ...
        'buff.ranged.desc': 'Получить Дальнюю Атаку (Дальность 3)',
        ...
        'buff.piercing': 'Арканное Пронзание',
